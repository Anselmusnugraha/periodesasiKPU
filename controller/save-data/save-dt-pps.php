...
$KET=$_POST['ket'];
	...
	echo "<meta http-equiv='refresh' content='1 url=../../data-pps.php?id_tgl='.$ID_TGL.''>";}
	elseif (empty($DESA)){
	echo "<script>alert('Desa/Kelurahan Belum Diisi!')</script>"; 
	echo "<meta http-equiv='refresh' content='1 url=../../data-pps.php?id_tgl='.$ID_TGL.''>";}
	...
	echo "<meta http-equiv='refresh' content='1 url=../../data-pps.php?id_tgl='.$ID_TGL.''>";}
		...
		$sql="insert into dt_pps values ('$NO','$ID_TGL','$KECAMATAN','$DESA','$JABATAN','$NAMA','$NIK','$JK','$TMP_LH','$TGL_LH','$USIA','$PENDIDIKAN','$PEKERJAAN','$ALAMAT','$NO_TELP','$EMAIL','$MEDSOS','$RWY_SAKIT','$KET')";
