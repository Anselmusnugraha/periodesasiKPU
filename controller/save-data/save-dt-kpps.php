...
$KET=$_POST['ket'];
	...
	echo "<meta http-equiv='refresh' content='1 url=../../data-kpps.php?id_tgl='.$ID_TGL.''>";}
		...
		$sql="insert into dt_kpps values ('$NO','$ID_TGL','$KECAMATAN','$DESA','$TPS','$JABATAN','$NAMA','$NIK','$JK','$TMP_LH','$TGL_LH','$USIA','$STATUS','$PENDIDIKAN','$PEKERJAAN','$AGAMA','$ALAMAT','$NO_TELP','$EMAIL','$MEDSOS','$RWY_SAKIT','$KET')";
