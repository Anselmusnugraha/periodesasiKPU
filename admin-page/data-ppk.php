...
$ID_TGL=$_GET['id_tgl'];
$dt=mysql_query("select tgl_inp from tgl_dft_ppk where id_tgl='$ID_TGL'");
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">DATA PPK TAHUN <?php echo $ForTGLInp; ?></strong>
<?php
}
?>
                            </div>
                            <div class="card-body">
                                <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#ModalInput"><i class="fa fa-pencil"></i> Input Data PPK</button>
...
?>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php 
                                        $no=1;
                                        $data = mysql_query("select * from dt_ppk where id_tgl='$ID_TGL'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a data-toggle="modal" data-target="#konfirmasi_hapus" title="Hapus" data-href="controller/del-data/delete-dt-ppk.php?&No=<?php echo $d['No']; ?> "><button type="button" class="btn btn-outline-danger"><i class="fa fa-trash"></i> Hapus</button></a>
                                            </td>
                                        </tr>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" action="controller/edit-data/edt-dt-ppk.php" method="get">
                        <?php
                        $ID_TGL=$_GET['id_tgl'];
                        $NO = $d['No'];
                          $sql1 = "select * from dt_ppk where No='$NO'";
                            ...
                            <div class="form-group">
                              <label for="kcmt" class="labelfrm">* Kecamatan</label>
                                <div class="input-group">
                                  ...
                                  <input id="kcmt" class="form-control" type="text" name="kcmt" required="true" autocomplete="off" placeholder="Kecamatan" value="<?php echo $View1['kcmt']; ?>">
                                </div>
                            </div>
                           </div>
                           <div class="col col-md-6"> 
                            ...
                            <div class="form-group">
                              <label for="nm" class="labelfrm">* Nama (Tanpa Gelar)</label>
                                <div class="input-group">
                                  ...
                                  <input id="nm" class="form-control" type="text" name="nm" required="true" autocomplete="off" placeholder="Nama Lengkap (Tanpa Gelar)" value="<?php echo $View1['nm']; ?>">
                                </div>
                            </div>
                           </div>
                           <div class="col col-md-6"> 
                            <div class="form-group">
                              <label for="nik" class="labelfrm">* NIK</label>
                                <div class="input-group">
                                  ...
                                  <input id="nik" class="form-control" type="text" name="nik" required="true" autocomplete="off" placeholder="Nomor Induk KTP" value="<?php echo $View1['nik']; ?>" onkeypress="return mungAngka(event)">
                                </div>
                            </div>
                           </div>
                        </div>
                           ...
                           <div class="col col-md-6"> 
                            <div class="form-group">
                              <label for="t_lh" class="labelfrm">* Tempat Lahir</label>
                                <div class="input-group">
                                  <span class="input-group-addon" id="basic-addon1"><span class="fa fa-map-marker"></span></span>
                                  <input id="t_lh" class="form-control" type="text" name="t_lh" required="true" autocomplete="off" placeholder="Tempat Lahir" value="<?php echo $View1['t_lh']; ?>">
                                </div>
                            </div>
                           </div>
                        </div>
                            ...
                            <div class="form-group">
                              <label for="us" class="labelfrm">* Usia</label>
                                <div class="input-group">
                                  ...
                                  <input id="us" class="form-control" type="text" name="us" required="true" autocomplete="off" placeholder="Usia" value="<?php echo $View1['us']; ?>" onkeypress="return mungAngka(event)">
                                </div>
                            </div>
                           </div>
                        </div>
                            ...
                            <div class="form-group">
                              <label for="pkj" class="labelfrm">* Pekerjaan</label>
                                <div class="input-group">
                                  ...
                                  <input id="pkj" class="form-control" type="text" name="pkj" required="true" autocomplete="off" placeholder="Pekerjaan" value="<?php echo $View1['pkj']; ?>">
                                </div>
                            </div>
                           </div>
                        </div>
                            ...
                            <div class="form-group">
                              <label for="almt" class="labelfrm">* Alamat</label>
                                <div class="input-group">
                                  ...
                                  <input id="almt" class="form-control" type="text" name="almt" required="true" autocomplete="off" placeholder="Alamat Lengkap" value="<?php echo $View1['almt']; ?>">
                                </div>
                            </div>
                           </div>
                           <div class="col col-md-6"> 
                            <div class="form-group">
                              <label for="hp_tlp" class="labelfrm">* Nomor Telp./Hp</label>
                                <div class="input-group">
                                  ...
                                  <input id="hp_tlp" class="form-control" type="text" name="hp_tlp" required="true" autocomplete="off" placeholder="Nomor HP/Telp." value="<?php echo $View1['hp_tlp']; ?>">
                                </div>
                            </div>
                           </div>
                        </div>
                            ...
                            <div class="form-group">
                              <label for="email" class="labelfrm">Email</label>
                                <div class="input-group">
                                  ...
                                  <input id="email" class="form-control" type="text" name="email" autocomplete="off" placeholder="Email" value="<?php echo $View1['email']; ?>">
                                </div>
                            </div>
                           </div>
                           <div class="col col-md-6"> 
                            <div class="form-group">
                              <label for="medsos" class="labelfrm">Media Sosial</label>
                                <div class="input-group">
                                  ...
                                  <input id="medsos" class="form-control" type="text" name="medsos" autocomplete="off" placeholder="Media Sosial" value="<?php echo $View1['medsos']; ?>">
                                </div>
                            </div>
                           </div>
                        </div>
                            ...
                            <div class="form-group">
                              <label for="rwy_sakit" class="labelfrm">Riwayat Sakit</label>
                                <div class="input-group">
                                  ...
                                  <input id="rwy_sakit" class="form-control" type="text" name="rwy_sakit" autocomplete="off" placeholder="Riwayat Sakit" value="<?php echo $View1['rwy_sakit']; ?>">
                                </div>
                            </div>
                           </div>
                           <div class="col col-md-6"> 
                            <div class="form-group">
                              <label for="ket" class="labelfrm">Keterangan</label>
                                <div class="input-group">
                                  ...
                                  <input id="ket" class="form-control" type="text" name="ket" autocomplete="off" placeholder="Ketrangan" value="<?php echo $View1['ket']; ?>">
                                </div>
                            </div>
                           </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="largeModalLabel" style="text-align: center;">Input Data PPK <i class="fa fa-pencil"></i></h3>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                    <span class="sr-only">Tutup</span>
                </button>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="controller/save-data/save-dt-ppk.php">
                <input type="hidden" name="id_tgl" value=<?php echo $ID_TGL; ?>>
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="kcmt" class="labelfrm">* Kecamatan</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-map-marker"></span></span>
                          <input id="kcmt" class="form-control" type="text" name="kcmt" required="true" autocomplete="off" placeholder="Kecamatan">
                        </div>
                    </div>
                   </div>
                   <div class="col col-md-6"> 
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="nm" class="labelfrm">* Nama (Tanpa Gelar)</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-font"></span></span>
                          <input id="nm" class="form-control" type="text" name="nm" required="true" autocomplete="off" placeholder="Nama Lengkap (Tanpa Gelar)">
                        </div>
                    </div>
                   </div>
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="nik" class="labelfrm">* NIK</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-credit-card"></span></span>
                          <input id="nik" class="form-control" type="text" name="nik" required="true" autocomplete="off" placeholder="Nomor Induk KTP" onkeypress="return mungAngka(event)">
                        </div>
                    </div>
                   </div>
                </div>
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="t_lh" class="labelfrm">* Tempat Lahir</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-map-marker"></span></span>
                          <input id="t_lh" class="form-control" type="text" name="t_lh" required="true" autocomplete="off" placeholder="Tempat Lahir">
                        </div>
                    </div>
                   </div>
                </div>
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="us" class="labelfrm">* Usia</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-unsorted"></span></span>
                          <input id="us" class="form-control" type="text" name="us" required="true" autocomplete="off" placeholder="Usia" onkeypress="return mungAngka(event)">
                        </div>
                    </div>
                   </div>
                </div>
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="pkj" class="labelfrm">* Pekerjaan</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-briefcase"></span></span>
                          <input id="pkj" class="form-control" type="text" name="pkj" required="true" autocomplete="off" placeholder="Pekerjaan">
                        </div>
                    </div>
                   </div>
                </div>
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="almt" class="labelfrm">* Alamat</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-home"></span></span>
                          <input id="almt" class="form-control" type="text" name="almt" required="true" autocomplete="off" placeholder="Alamat Lengkap">
                        </div>
                    </div>
                   </div>
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="hp_tlp" class="labelfrm">* Nomor Telp./Hp</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-phone"></span></span>
                          <input id="hp_tlp" class="form-control" type="text" name="hp_tlp" required="true" autocomplete="off" placeholder="Nomor HP/Telp.">
                        </div>
                    </div>
                   </div>
                </div>
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="email" class="labelfrm">Email</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-envelope-o"></span></span>
                          <input id="email" class="form-control" type="text" name="email" autocomplete="off" placeholder="Email">
                        </div>
                    </div>
                   </div>
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="medsos" class="labelfrm">Media Sosial</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-comments-o"></span></span>
                          <input id="medsos" class="form-control" type="text" name="medsos" autocomplete="off" placeholder="Media Sosial">
                        </div>
                    </div>
                   </div>
                </div>
                   ...
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="rwy_sakit" class="labelfrm">Riwayat Sakit</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-stethoscope"></span></span>
                          <input id="rwy_sakit" class="form-control" type="text" name="rwy_sakit" autocomplete="off" placeholder="Riwayat Sakit">
                        </div>
                    </div>
                   </div>
                   <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="ket" class="labelfrm">Keterangan</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-tag"></span></span>
                          <input id="ket" class="form-control" type="text" name="ket" autocomplete="off" placeholder="Ketrangan">
                        </div>
                    </div>
                   </div>
                </div>
...
<div class="modal fade" id="ModalImport" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->  
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Import Data PPK (Ms. Excel) <i class="fa fa-upload"></i></h3>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                    <span class="sr-only">Tutup</span>
                </button>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" enctype="multipart/form-data" action="upload-aksi-ppk.php?id_tgl=<?php echo $ID_TGL;?>">
