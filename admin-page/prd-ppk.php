                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1>Cek Data Periodesasi PPK</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Cek Data PPK</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Cek Data PPK</strong>
                            </div>
                            <div class="card-body">
                            <div class="row">
                                ...
                                <form method="POST" action="">
                                            <label for="kategori">
                                                <select name="kategori" required="true" class="form-control" tabindex="1">
                                                     ...
                                                     <option value="kcmt">Kecamatan</option>
                                                </select>
                                            </label>
                                            <label>
...
?>  
                                    ...
                                    <a href="print-prd-ppk.php?src=<?php echo $search; ?>&ktg=<?php echo $ktgr; ?>"><button type="button" class="btn btn-outline-primary"><i class="fa fa-print"></i> Cetak</button></a>
