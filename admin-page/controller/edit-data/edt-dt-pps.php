...
while ($data = mysql_fetch_array($query)) {
	...
	echo "<meta http-equiv='refresh' content='1 url=../../data-pps.php?id_tgl='.$ID_TGL.''>";}
	elseif (empty($NO)){
	...
	echo "<meta http-equiv='refresh' content='1 url=../../data-pps.php?id_tgl='.$ID_TGL.''>";}
		...
		$sql1="update dt_pps SET kcmt='$KECAMATAN', ds_kel='$DESA', jbtn='$JABATAN', nm='$NAMA', nik='$NIK', jk='$JK', t_lh='$TMP_LH', tgl_lh='$TGL_LH', us='$USIA', pndd='$PENDIDIKAN', pkj='$PEKERJAAN', almt='$ALAMAT', hp_tlp='$NO_TELP', email='$EMAIL', medsos='$MEDSOS', rwy_sakit='$RWY_SAKIT', ket='$KET' where No='$NO'";
