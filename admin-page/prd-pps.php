                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1>Cek Data Periodesasi PPS</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Cek Data PPS</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Cek Data PPS</strong>
                            </div>
                            <div class="card-body">
                            <div class="row">
...
<?php
  ...
  if (isset($_POST['submit'])) {
   ...
   $ktgr = $_POST['kategori'];
?>
                                            <a href="print-prd-pps.php?src=<?php echo $search; ?>&ktg=<?php echo $ktgr; ?>&ds=<?php echo $DESA ?>"><button type="button" class="btn btn-outline-primary"><i class="fa fa-print"></i> Cetak</button></a>
                                <br><br>
                              </div>
                            </div>
