                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Pendaftaran KPPS</strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <?php 
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="data-kpps.php?id_tgl=<?php echo $View['id_tgl']; ?>"><button type="button" class="btn btn-outline-primary"><i class="fa fa-plus"></i> Input Data</button></a>
                                                ...
                                                <a data-toggle="modal" data-target="#konfirmasi_hapus" title="Hapus" data-href="controller/del-data/delete-tanggal.php?&id_tgl=<?php echo  $View['id_tgl']; ?>"><button type="button" class="btn btn-outline-danger"><i class="fa fa-trash"></i> Hapus</button></a>
                                            </td>
                                        </tr>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" action="controller/edit-data/edt-tgl-kpps.php" method="get">
                        <?php
                        $ID_TGL = $View['id_tgl'];
                          $sql1 = "select * from tgl_dft_kpps where id_tgl='$ID_TGL'";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Input Tanggal Daftar KPPS <i class="fa fa-pencil"></i></h3>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                    <span class="sr-only">Tutup</span>
                </button>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="POST" action="controller/save-data/save-inp-tgl-kpps.php">
