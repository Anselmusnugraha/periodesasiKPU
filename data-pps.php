...
$ID_TGL=$_GET['id_tgl'];
$dt=mysql_query("select tgl_inp from tgl_dft_pps where id_tgl='$ID_TGL'");
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">DATA PPS TAHUN <?php echo $ForTGLInp; ?></strong>
<?php
}
?>
                            </div>
                            <div class="card-body">
                                <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#ModalInput"><i class="fa fa-pencil"></i> Input Data PPS</button>
...
?>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php 
                                        $no=1;
                                        $data = mysql_query("select * from dt_pps where id_tgl='$ID_TGL'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a data-toggle="modal" data-target="#konfirmasi_hapus" title="Hapus" data-href="controller/del-data/delete-dt-pps.php?&No=<?php echo $d['No']; ?> "><button type="button" class="btn btn-outline-danger"><i class="fa fa-trash"></i> Hapus</button></a>
                                            </td>
                                        </tr>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" action="controller/edit-data/edt-dt-pps.php" method="get">
                        <?php
                        $ID_TGL=$_GET['id_tgl'];
                        $NO = $d['No'];
                          $sql1 = "select * from dt_pps where No='$NO'";
                  ...
                  <div class="col col-md-6"> 
                    <div class="form-group">
                      <label for="ds_kel" class="labelfrm">* Desa/Kelurahan</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-map-marker"></span></span>
                          <input id="ds_kel" class="form-control" type="text" name="ds_kel" required="true" autocomplete="off" value="<?php echo $View1['ds_kel']; ?>">
                        </div>
                    </div>
                   </div>
                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="largeModalLabel" style="text-align: center;">Input Data PPS <i class="fa fa-pencil"></i></h3>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                    <span class="sr-only">Tutup</span>
                </button>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="controller/save-data/save-dt-pps.php">
                <input type="hidden" name="id_tgl" value=<?php echo $ID_TGL; ?>>
...
<div class="modal fade" id="ModalImport" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->  
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Import Data PPS (Ms. Excel) <i class="fa fa-upload"></i></h3>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                    <span class="sr-only">Tutup</span>
                </button>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" enctype="multipart/form-data" action="upload-aksi-pps.php?id_tgl=<?php echo $ID_TGL;?>">
